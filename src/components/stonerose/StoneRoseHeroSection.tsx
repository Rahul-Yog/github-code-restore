...
const StoneRoseHeroSection = () => {
  ...
  return (
    <>
      {/* Hero Image Section */}
      <section className="relative h-[60vh] md:h-[70vh] flex items-center justify-center pt-16">
        {/* Background Image */}
        ...
        <div className="absolute top-24 left-1/2 transform -translate-x-1/2 z-20 w-full px-4">
          <div className="max-w-4xl mx-auto">
            <div className="flex flex-col sm:flex-row gap-2 justify-center items-center">
              {/* Builder Highlight */}
              <div className="inline-flex items-center gap-2 bg-gradient-to-r from-accent/95 to-accent/85 backdrop-blur-md text-white px-4 py-2 rounded-full text-xs sm:text-sm font-bold border border-white/40 shadow-lg">
                <span className="text-lg">👑</span>
                <span>Treasure Hill Homes</span>
              </div>
              
              {/* HST Badge */}
              <div className="inline-flex items-center gap-1.5 bg-primary/95 backdrop-blur-md text-white px-3 py-1.5 sm:px-4 sm:py-2 rounded-full text-xs sm:text-sm font-bold border border-white/30 shadow-lg">
      ...
      <section className="bg-background py-12 md:py-16 border-b border-border">
        <div className="container mx-auto px-4">
          <div className="max-w-5xl mx-auto text-center space-y-6">
            ...
            {/* Subheadline */}
            <h2 className="text-base md:text-xl text-muted-foreground max-w-3xl mx-auto font-semibold">
            ...
            <div className="flex flex-wrap justify-center gap-3 text-xs sm:text-sm pt-2">
              <div className="flex items-center gap-1.5 text-foreground bg-muted px-3 py-1.5 rounded-full">
              ...
              <div className="inline-flex items-center gap-1.5 bg-muted text-foreground px-2.5 py-1.5 rounded-full">
            ...
            <div className="flex flex-col sm:flex-row gap-3 justify-center items-center pt-4">
              ...
              <Button
                size="lg"
                variant="outline"
                className="text-sm sm:text-base px-6 py-4 sm:py-5 border-2 w-full sm:w-auto"

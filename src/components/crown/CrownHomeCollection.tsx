  ...
  const townhomeCollections = [
    {
      ...
      features: ['3 Bedrooms', '2.5-3 Bathrooms', '2 Car Garage', '1,602-1,620 sq ft'],
    ...
    },
    {
      ...
      features: ['3 Bedrooms', '2.5-3 Bathrooms', '2 Car Garage', '1,620+ sq ft'],
    ...
    },
    {
      ...
      features: ['3-4 Bedrooms', '3-4 Bathrooms', '1 Car Garage', '1,800+ sq ft'],
